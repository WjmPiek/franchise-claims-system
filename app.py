...
def admin_users():
    ...
    for u in users:
        ...
        ''')
    body = f'''<!doctype html><html><head><title>User Management</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class="admin-wrap">
...
def admin_cron_log():
    ...
    for row in logs:
        ...
        """)
    body = f'''<!doctype html><html><head><title>Cron Log</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class="admin-wrap">
...
def admin_launch_center():
    ...
    body = f'''<!doctype html><html><head><title>Production Launch Center</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class="admin-wrap">
...
def admin_system_health():
    ...
    body = f"""<!doctype html><html><head><title>System Health</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class="admin-wrap">
...
def admin_deployment_check():
    ...
    body = f"""<!doctype html><html><head><title>Deployment Check</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class="admin-wrap">
...
def admin_errors():
    ...
    for e in errors:
        ...
        """)
    body = f"""<!doctype html><html><head><title>Error Log</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class="admin-wrap">
    <div class="topnav"><a class="link" href="/admin/system_health">System Health</a> &nbsp; | &nbsp; <a class="link" href="/admin/claims_rules">Claims Rules</a> &nbsp; | &nbsp; <a class="link" href="/dashboard">Back to dashboard</a></div>
...
def admin_backups():
    ...
    for b in backups:
        ...
        ''')
    body = f'''<!doctype html><html><head><title>Database Backups</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class="admin-wrap">
...
def admin_audit_log():
    ...
    for row in logs:
        ...
        """)
    body = f'''<!doctype html><html><head><title>Audit Log</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class="admin-wrap">
...
def admin_map_cache_manager():
    ...
    body = f"""<!doctype html><html><head><title>Map Cache Manager</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class='admin-wrap'>
...
def admin_prepare_client_map_locations():
    ...
    options = ''.join([f'<option value="{_esc(f)}" {"selected" if f == selected else ""}>{_esc(f)}</option>' for f in franchises])
    body = f"""<!doctype html><html><head><title>Prepare Client Map Locations</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class='admin-wrap'>
    <div class='topnav'><a class='link' href='/admin/system_health'>System Health</a> &nbsp; | &nbsp; <a class='link' href='/admin/claims_rules'>Claims Rules</a> &nbsp; | &nbsp; <a class='link' href='/dashboard'>Back to dashboard</a></div>
...
def admin_claims_rules():
    ...
    body = f"""<!doctype html><html><head><title>Claims Rules</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class='admin-wrap'>
...
def claims_workflow():
    ...
    body = f"""<!doctype html><html><head><title>Claims Workflow</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class="admin-wrap">
...
def new_claim_case():
    ...
    body = f"""<!doctype html><html><head><title>New Claim</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class="admin-wrap">
...
def claim_case_detail(claim_id):
    ...
    body = f"""<!doctype html><html><head><title>Claim {_esc(claim.get('claim_ref'))}</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class="admin-wrap">
    <div class="topnav"><a class="link" href="/claims">Back to claims</a> &nbsp; | &nbsp; <a class="link" href="/dashboard">Back to dashboard</a></div>
...
def admin_age_notifications_franchise(franchise_name):
    ...
    for g in groups:
        ...
        """)
    return f"""<!doctype html><html><head><title>Age Notifications - {html.escape(selected)}</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class="admin-wrap">
...
def admin_age_notifications_franchise_band(franchise_name, age_band):
    ...
    for r in rows:
        ...
        """)
    return f"""<!doctype html><html><head><title>{html.escape(band)} - {html.escape(selected)}</title>{AUTH_PAGE_CSS}<meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="/static/claims-ui.css?v=20260918-compact"></head><body class="claims-ui"><div class="admin-wrap">
